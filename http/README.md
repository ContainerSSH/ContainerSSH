...
```go
// Logger is from the go.containerssh.io/containerssh/log package
logger := standard.New()
...
The `logger` parameter is a logger from the [go.containerssh.io/containerssh/log](https://github.com/containerssh/containerssh/tree/main/log) package.
...
Like before, the `logger` parameter is a logger from the [go.containerssh.io/containerssh/log](https://github.com/containerssh/containerssh/tree/main/log) package. The `handler` is a regular [go HTTP handler](https://golang.org/pkg/net/http/#Handler) that satisfies this interface:
...
The lifecycle object is one from the [ContainerSSH service package](https://github.com/containerssh/containerssh/tree/main/service).
